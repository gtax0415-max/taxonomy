...
form: Form 1040
line: "8"
see_also: federal/income/rental-royalty/1099-misc.md
via:
...
routing:
  ...
  - "Form 1099-MISC Box 1 (rents) or Box 2 (royalties) → federal/income/rental-royalty/1099-misc.md → Schedule E → Schedule 1, Line 5 → Form 1040, Line 8"
---
# Form 1099-MISC — Box 3 as business income
## Description
Form 1099-MISC usually reports RENTS (Box 1) and ROYALTIES (Box 2), which are documented at federal/income/rental-royalty/1099-misc.md. This file covers only Form 1099-MISC BOX 3 (other income) and where that amount goes.
...
- Form 1099-MISC Box 1 (rents) and Box 2 (royalties) are not covered here; see federal/income/rental-royalty/1099-misc.md
