...
source_doc: Form 1099-S Box 2 (gross proceeds) if issued / closing statements from both the purchase and the sale / receipts for capital improvements / depreciation records if the home was ever rented or used for a home office
form: Form 1040
line: "7"
via:
  - Form 8949 → Schedule D → Form 1040, Line 7 (only the NON-excluded gain)
routing:
  - "Gain fully excluded under Section 121 and no Form 1099-S received → nothing to report"
  - "Gain fully excluded but Form 1099-S was issued → report on Form 8949 and back out the exclusion → Schedule D → Form 1040, Line 7"
  - "Gain above the exclusion → Form 8949 → Schedule D → Form 1040, Line 7, taxed as long-term capital gain"
  - "Unrecaptured Section 1250 gain from prior depreciation → NOT excludable → taxed at a maximum 25% rate"
  - "LOSS on a personal residence → NOT deductible and not reported"
---
# Sale of a Home — Section 121 Exclusion
## Description
Selling a principal residence can exclude up to $250,000 of gain from tax, or $500,000 for a married couple filing jointly. For most homeowners this is the single largest tax break they will ever claim.
## The exclusion amounts
- $250,000 for single, head of household, and married filing separately
- $500,000 for married filing jointly
- Set by the Taxpayer Relief Act of 1997 and NOT indexed for inflation, so they have not changed since 1997
- The exclusion is PERMANENT, not a deferral. Excluded gain is never taxed and there is no requirement to reinvest
## The two tests — both required
Within the FIVE YEARS ending on the date of sale, you must have:
1. OWNERSHIP TEST — owned the home for at least 24 months
2. USE TEST — used it as your principal residence for at least 24 months
The two periods can overlap, and the months do not have to be consecutive. The count is 730 days, not tax years.
## Married couples — an asymmetry worth knowing
...
## Partial exclusion
If you fail a test because of a JOB CHANGE, HEALTH reason, or certain UNFORESEEN CIRCUMSTANCES, a proportional partial exclusion is available based on the months actually satisfied.
...
- Purchase date, purchase price, and closing costs from the original purchase
- Sale date, sale price, and selling costs
- Capital improvements made over the ownership period
- Months of ownership and months of principal-residence use within the last five years
- Any depreciation claimed for a home office or rental period
- Whether the exclusion was used on another sale in the last two years
- Form 1099-S, if the closing agent issued one
## Questions
- How long did you own the home, and how long did you live in it as your main home?
- If married, did BOTH of you live there at least 24 months of the last 5 years?
...
- Failing to report a sale when Form 1099-S was issued, even though the gain was fully excluded
- Assuming the full $500,000 applies when only one spouse meets the use test
...
- I sold a house I used to rent out and later lived in.
